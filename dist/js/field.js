...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-BooleanToggle', __webpack_require__(3));
  Vue.component('detail-BooleanToggle', __webpack_require__(6));
  Vue.component('form-BooleanToggle', __webpack_require__(9));
});
    ...
    methods: {
        toggleValue: function toggleValue() {
            ...
            axios.post('/nova-vendor/pnpd-boolean-toggle/toggle', {
                ...
                _this.field.value = _this.field.value ? false : true;
            });
            return false;
        }
    },
...
var render = function() {
  ...
  return _c("div", { class: "text-" + _vm.field.textAlign }, [
    _c(
      "a",
      { staticClass: "cursor-pointer", on: { click: _vm.toggleValue } },
